...
import gabriellee.project.foodrecipes.adapters.OnRecipeListener;
import gabriellee.project.foodrecipes.adapters.RecipeRecyclerAdapter;
import gabriellee.project.foodrecipes.models.Recipe;
import gabriellee.project.foodrecipes.util.Testing;
import gabriellee.project.foodrecipes.util.VerticalSpacingItemDecorator;
...
public class RecipeListActivity extends BaseActivity implements OnRecipeListener {
    ...
    private void subscribeObservers() {
        ...
        mRecipeListViewModel.isQueryExhaused().observe(this, new Observer<Boolean>() {
            @Override
